...
@section('page-title')
    <h1>
        <i class="fa fa-user"></i> Create a new {{ $config['leads']['label'] }}
    </h1>
    <p class="lead">
...
@section('col1')
    <div class="well"><!-- Well -->
        <h4 class="text-primary1"><i class="fa fa-pencil"></i> Tell me about this new {{ $config['lead']['label'] }}...</h4>
