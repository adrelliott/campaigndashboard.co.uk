...
@section('modal-body')
    ...
    {{ Former::open()
        ...
        {{ Former::text('note_title')->class('form-control input-lg')->placeholder('E.g. Phone call')->label('Note
Title') }}

        {{ Former::textarea('note_body')->class('form-control input-lg')->placeholder('E.g. They wanted to know where
their order was. I told them it had been dispatched.')->rows(8)->label('Note') }}
